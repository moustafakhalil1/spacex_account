/** @odoo-module **/
    ...
    patch(registry.category("web_tour.tours").get("account_tour"), {
        steps() {
            ...
            originalSteps.splice(0, 3,
                ...stepUtils
                    .goToAppSteps("spacex_account.menu_accounting", _t("Go to invoicing"))
    ...
    registry.category("web_tour.tours").add('account_accountant_tour', {
            ...
            sequence: 50,
            steps: () => [
            ...stepUtils.goToAppSteps('spacex_account.menu_accounting', _t('Let’s automate your bills, bank transactions and accounting processes.')),
